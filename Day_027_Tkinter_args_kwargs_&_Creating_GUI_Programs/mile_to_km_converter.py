...
my_label = Label(font=("Arial", 12))
my_label.config(text="Welcome to the miles to km converter.")
my_label.place(x=20, y=0)

my_label = Label(font=("Arial", 12))
my_label.config(text="Enter number and hit 'Calculate' to convert.")
my_label.place(x=5, y=20)
...
button.place(x=130, y=59, width=100, height=32)
